...
public class Cafe {
	...
	public static void main(String args[]) {
		...
		// with iterators
		com.comprehensive.practice.designpatterns.behavioralPattern.collections.iterator.Iterator pancakeIterator = pancakeHouseMenu.createIterator();
		com.comprehensive.practice.designpatterns.behavioralPattern.collections.iterator.Iterator dinerIterator = dinerMenu.createIterator();
